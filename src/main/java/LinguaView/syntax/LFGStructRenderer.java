...
/**
 * LFGStructRenderer loads in one specified LFG structure at a time.
 * Then it passes it to FeatureLayoutRenderer and ConstTreeRenderer, respectively, to arrange their layout.
 * After individual layout of c-structure and f-structure is done,
 * LFGStructRenderer adjust their y-loc to make it looks better, and adds correspondences between c-structures and f-structures.
 * 
 * @author shuoyang
 *
 */
@SuppressWarnings("serial")
public class LFGStructRenderer extends TreeRenderer<Element> {
	/**
	 * fstruct arranges layout of f-structure
	 */
	private FeatureStructure fstruct;
	/**
	...
	int cfGap = 50;
	/**
	 * the left and top margin of c-structure of f-structure before adjustment of LFGStructRenderer
	 */
	int cLeftMarginOrig;
	int fLeftMarginOrig;
	int cTopMarginOrig;
	...
	/**
	 * FeatureStructure is a wrapper class for using FeatureLayout1 in LFGStructRenderer.
	 * Except for overridden init() method and a new SetXStartPos() method for adjustment,
	 * this class is the same as FeatureLayoutRenderer
	 * 
	 * @author shuoyang
	 *
	 */
	...
	/**
	 * ConstStructure is a wrapper class for using ConstTreeRenderer in LFGStructRenderer.
	 * Except for overridden init() method and a new SetXStartPos() method for adjustment,
	 * this class is the same as ConstTreeRenderer
	 * 
	 * @author shuoyang
	 *
	 */
