 ...
 * from Java code.
 *
 * ReferencedSVGGraphics2D generates a DOM tree whose root is obtained through
 ...
 * DOM tree.
 *
 * The ReferencedSVGGraphics2D class can produce a DOM tree using any implementation
 * that conforms to the W3C DOM 1.0 specification (see http://www.w3.org).
 * At construction time, the ReferencedSVGGraphics2D must be given a org.w3.dom.Document
 ...
 * @version $Id: ReferencedSVGGraphics2D.java 1372129 2012-08-12 15:31:50Z helder $
 ...
 */
public class ReferencedSVGGraphics2D extends AbstractGraphics2D
     ...
     * and growing the SVG tree. This ReferencedSVGGraphics2D relies on
     ...
     * Note that each ReferencedSVGGraphics2D instance has its own DOMGroupManager
     * (i.e., its own current group) but that all ReferencedSVGGraphics2D
     * originating from the same ReferencedSVGGraphics2D through various
    ...
    /**
     * @return the SVGGeneratorContext used by this ReferencedSVGGraphics2D instance.
     */
    ...
    /**
     * @return the SVGShape used by this ReferencedSVGGraphics2D instance to
    ...
    /**
     * @return the DOMTreeManager used by this ReferencedSVGGraphics2D instance
     */
    ...
    /**
     * Set a DOM Tree manager for the ReferencedSVGGraphics2D.
     * @param treeMgr the new DOM Tree manager this ReferencedSVGGraphics2D should use
     */
     ...
     /**
     * @return the DOMGroupManager used by this ReferencedSVGGraphics2D instance
     */
    ...
    /**
     * Set a new DOM Group manager for this ReferencedSVGGraphics2D.
     * @param groupMgr the new DOM Group manager this ReferencedSVGGraphics2D should use
     */
     ...
     *         ReferencedSVGGraphics2D instance
     */
    ...
    /**
     * @return the ImageHandler used by this ReferencedSVGGraphics2D instance
     */
    ...
    /**
     * @return the GenericImageHandler used by this ReferencedSVGGraphics2D instance
     */
    ...
    /**
     * @return the extension handler used by this ReferencedSVGGraphics2D instance
     */
    ...
    /**
     * @param extensionHandler new extension handler this ReferencedSVGGraphics2D
     *        should use
     */
     ...
     */
    public ReferencedSVGGraphics2D(Document domFactory) {
    ...
    /**
     * Creates a new ReferencedSVGGraphics2D object.
     ...
     */
    public ReferencedSVGGraphics2D(SVGGeneratorContext generatorCtx,
                                   boolean textAsShapes) {
        super(textAsShapes);
     ...
     * @see #create
     */
    public ReferencedSVGGraphics2D(ReferencedSVGGraphics2D g) {
        super(g);
    ...
    public Graphics create(){
        return new ReferencedSVGGraphics2D(this);
    }
     ...
     */
    public Element drawAsElement(Shape s) {
        ...
        if (stroke instanceof BasicStroke) {
            ...
            return fillAsElement(strokedShape);
        }
    }
     ...
     * @see #setClip(Shape)
     */
    public Element drawStringAsElement(String s, float x, float y) {
        if (textAsShapes)  {
            GlyphVector gv = getFont().
                createGlyphVector(getFontRenderContext(), s);
            Shape stringShape = gv.getOutline(x, y);
            return fillAsElement(stringShape);
        }
     ...
     * @see #setClip(Shape)
     */
    public Element fillAsElement(Shape s) {
        Element svgShape = shapeConverter.toSVG(s);
        if (svgShape != null) {
